...
<title>SIGMA - Administrador</title>
				...
				<div class="container-fluid">
					...
					<div class="btn-group pull-right">
						<a href="#" class="btn btn-primary" title="Tooltip."> <i
							class="icon-user icon-white"></i> AdminiName
				...
				<div class="row-fluid" style="position: relative !important;">
					<div style="padding-left: 25px;">
						...
						<ul class="thumbnails centralizar-texto">
							...
							<li class="span3">
								<div class="thumbnail">
									<a href="/adminGerenciarUsuarios.jsp"> <img
										src="e/gerencUsuar.png" alt="Gerenciar usuários"
							...
							<li class="span3">
								<div class="thumbnail">
									<a href="/adminFrequencia.jsp"> <img src="e/frequencia.png"
										alt="Frequência" title="Frequência">
									</a>
								</div>
							</li>
							<%
