				...
				<div class="container-fluid">
					...
					<div class="btn-group pull-right">
						<a href="#" class="btn btn-primary" title="Tooltip."> <i
							class="icon-user icon-white"></i> ProfessorName
				...
				<div class="row-fluid" style="position: relative !important;">
					<div style="padding-left: 25px;">
						...
						<ul class="thumbnails centralizar-texto">
							<li class="span3">
								<div class="thumbnail">
									<a href="professorAvaliarMonitor.jsp"> <img
										src="e/avalMonit.png" alt="Avaliar monitor"
						...
						<div class="span12">
							<div class="text-center">
								...
								<p class="mensagem-documento">Ainda não está disponível o
									documento de avaliação dos monitores.</p>
